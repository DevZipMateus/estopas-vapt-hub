...
const Footer = () => {
  ...
  return <footer className="section-dark section-padding">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div className="lg:col-span-2">
            <img src="/lovable-uploads/f63ef34c-f0d4-41f5-ad04-9480db1811bd.png" alt="Estopas Vapt Logo" className="h-28 w-auto mb-28 filter brightness-0 invert" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              id: '#contato'
                  ...
                  <button onClick={() => scrollToSection(link.id)} className="text-gray-300 hover:text-primary transition-colors duration-300">
                    {link.label}
                  </button>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              <button onClick={handleMapClick} className="flex items-start text-gray-300 hover:text-primary transition-colors duration-300 text-left">
              ...
              <button onClick={handleWhatsAppClick} className="flex items-center text-gray-300 hover:text-primary transition-colors duration-300">
                <Phone className="w-5 h-5 mr-3 flex-shrink-0" />
                <span className="text-sm">(65) 98174-8423</span>
              </button>

              <button onClick={handleEmailClick} className="flex items-center text-gray-300 hover:text-primary transition-colors duration-300">
                <Mail className="w-5 h-5 mr-3 flex-shrink-0" />
                <span className="text-sm">estopasvaptcba@gmail.com</span>
              </button>

              <button onClick={handleInstagramClick} className="flex items-center text-gray-300 hover:text-primary transition-colors duration-300">
